        ...
        {sections.map(({ groupId, items: sectionItems }) => (
          <div key={groupId ?? sectionItems[0].id}
            ...
            {sectionItems.map(item => {
              const catColor = PLACE_CATEGORY_COLORS[item.category as PlaceCategory] ?? "#6B7280";
              const catLabel = PLACE_CATEGORY_LABELS[item.category as PlaceCategory] ?? item.category;
